...
@tabular[#:style 'boxed
         ...
         (list (list @bold{Time}  @bold{Monday} @bold{Tuesday} @bold{Wednesday} @bold{Thursday}   @bold{Friday})
               (list  "8:00 AM"   'cont         'cont          'cont            "Kalyan"          'cont)
               (list  "8:30 AM"   'cont         'cont          'cont            "Kalyan"          'cont)
               (list  "9:00 AM"   'cont         "Kalyan"       "Deena"          "Kalyan"          'cont)
               (list  "9:30 AM"   'cont         "Kalyan"       "Deena"          "Kalyan"          'cont)
               (list "10:00 AM"   "Peter"       "Kalyan"       "Deena"          'cont             "Peter")
               (list "10:30 AM"   "Peter"       "Kalyan"       "Deena"          'cont             "Peter")
               (list "11:00 AM"   "Peter"       "Deena"        "Deena"          "Deena"           "Peter")
               (list "11:30 AM"   "Peter"       "Deena"        "Deena"          "Deena"           "Peter")
               (list "12:00 PM"   "Eric"        'cont          "Samuel, Eric"   'cont             'cont)
               (list "12:30 PM"   "Eric"        "Eric"         "Samuel, Eric"   "Samuel"          'cont)
               (list  "1:00 PM"   'cont         "Eric"         "Samuel"         "Samuel, Kalyan"  'cont)
               (list  "1:30 PM"   'cont         'cont          "Samuel"         "Kalyan"          'cont)
               (list  "2:00 PM"   "Edward"      "Sanchay"      "Edward"         "Sanchay, Pierce" "Edward")
               (list  "2:30 PM"   "Edward"      "Sanchay"      "Edward"         "Sanchay, Pierce" "Edward")
               (list  "3:00 PM"   'cont         'cont          'cont            "Pierce"          "Sanchay")
               (list  "3:30 PM"   "Emma"        'cont          "Emma"           "Pierce"          "Sanchay")
               (list  "4:00 PM"   "Emma"        'cont          "Emma"           'cont             "Peter")
               (list  "4:30 PM"   "Emma"        'cont          "Emma"           'cont             "Peter")
